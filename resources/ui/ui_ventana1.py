...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 322, 460))
        ...
        self.BOMBILLA = QPushButton(self.Puertas)
        self.BOMBILLA.setObjectName(u"BOMBILLA")

        self.verticalLayout_2.addWidget(self.BOMBILLA)

        self.DISPLAY = QPushButton(self.Puertas)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.BOMBILLA.setText(QCoreApplication.translate("MainWindow", u"BOMBILLA", None))
